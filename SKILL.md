...
|-------|-----------|---------|------------|
| [Bug Fixer](bug-fixer/SKILL.md) | `/workflow-architect:bug-fixer` | 7-dimension code review + bug fix | ✅ Yes |
| [Issue Changer](issue-changer/SKILL.md) | `/workflow-architect:issue-changer` | Change request management (mid-execution & post-completion) | ❌ Requires `.workflow/` |
