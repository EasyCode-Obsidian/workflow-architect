...
when_to_use: >-
  ...
  find potential risks, workflow-architect 3-Strike escalation (Option E),
...
<!-- 根据 .workflow/state.json 是否存在及当前阶段，自动选择工作模式。 -->
...
<!-- 在 workflow-architect 工作流中运行，利用完整的上下文信息。 -->
...
3. Persist review report to `.workflow/bug-fixer/review-N.md`
