...
#   DEEPWIKI_CACHE_DIR - cache directory path (default: .project-surgeon/deepwiki-cache)
...
$CACHE_DIR = if ($env:DEEPWIKI_CACHE_DIR) { $env:DEEPWIKI_CACHE_DIR } else { ".project-surgeon/deepwiki-cache" }
