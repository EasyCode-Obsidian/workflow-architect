...
when_to_use: >-
  ...
  improve code quality, audit existing system, understand legacy code,
  modernize project, comprehensive code review with fixes, project health check,
  接管项目, 重构代码, 代码审查.
  DO NOT trigger for: building from scratch (use workflow-architect),
  single-file quick fixes, simple QA tasks under 5 tool calls,
  从零开始的新项目.
user-invocable: true
arguments:
  - project_path
