...
when_to_use: >-
  TRIGGER when: requirements gathering, deep interview, project scoping, user research,
  understanding what to build, clarifying ambiguous requests.
  DO NOT trigger for: code review (use code-reviewer), bug fixing (use bug-fixer),
  project analysis (use project-surgeon).
user-invocable: true
arguments:
  - topic
