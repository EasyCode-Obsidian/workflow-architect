...
| File | When to Read | Description |
|------|-------------|-------------|
| [state-management.md](../../project-surgeon/references/state-management.md) | State schema and transitions | JSON schema, persistence rules, change_requests field |
| [phase-3-planning.md](../../project-surgeon/references/phase-3-planning.md) | Creating/modifying plan files | 3-level plan hierarchy, templates, consistency checks |
| [phase-4-execution.md](../../project-surgeon/references/phase-4-execution.md) | Resuming execution after changes | Execution loop, resume protocol, progress tracking |
