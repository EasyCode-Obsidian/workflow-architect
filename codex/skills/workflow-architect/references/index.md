...
| [pre-research-protocol.md](pre-research-protocol.md) | Phase 0 (pre-research) | 3-agent parallel research, Context Bus, consolidation |
...
| [deepwiki-integration.md](deepwiki-integration.md) | All phases — research at decision points and before coding | 3-tier DeepWiki research protocol, script usage, caching |
