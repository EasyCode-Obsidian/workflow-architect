...
1. **Research** — Run 1-2 web searches about architecture patterns for this project type. Output `🔍 Research Findings` block.
...
After BS-5 completes, offer three explicit options to the user:
