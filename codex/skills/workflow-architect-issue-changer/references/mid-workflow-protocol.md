...
1. **User explicitly invokes** `issue-changer` during Phase 4 execution
...
| Explicit invocation (显式调用) | +10 | `issue-changer` |
...
|-------------|-------|-------|
| `issue-changer add notifications` | +10 | HIGH |
